...
async def update_photo_description(
    ...
    auth_service.is_owner_or_admin(photo.user_id, current_user)

    updated = await repository_photos.update_photo_description(photo_id, body, db)
    return updated
...
async def transform_photo(
    ...
    return await repository_photos.transform_photo(photo_id, transformation, db)
...
async def generate_qr_code(
    ...
    return await repository_photos.generate_qr_code(photo_id, db)
